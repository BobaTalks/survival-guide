...
const Faq = () => {
  const [faqs,setFaqs] = useState([{title:"When should I start applying to universities/colleges?", 
  body:"This is ideally done in the fall of your last year of high SpeechRecognitionResultList(senior year/Grade 12 year)", id:1},
  ...
  , id:2},{title:"What if I'm undecided about my major?", 
  ...
  , id:3},{title:"Should I apply for financial aid, and if so, how and when?", 
